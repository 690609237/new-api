...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/status/api-info", controller.GetStatusApiInfo)
		apiRouter.GET("/status/announcements", controller.GetStatusAnnouncements)
		apiRouter.GET("/status/faq", controller.GetStatusFAQ)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/daily_review_test", controller.TestDailyReviewConnection)
