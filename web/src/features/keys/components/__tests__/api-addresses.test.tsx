...
function renderAddresses(status: StatusData) {
  const { api_info: apiInfo = [], ...statusData } = status
  client.setQueryData(STATUS_QUERY_KEY, statusData)
  client.setQueryData(['status-content', 'api-info'], apiInfo)
  return render(
